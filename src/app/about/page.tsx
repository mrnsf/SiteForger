...
import { ArrowRight, CheckCircle, Users, Target, Zap, Award, Phone, Mail } from 'lucide-react'
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
              ...
              <span className="text-blue-600"> for contractors</span>
            </h1>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              ...
              <div className="flex items-center space-x-3">
                ...
                <a href="mailto:hello@siteforger.com" className="text-lg hover:text-blue-400 transition-colors">
